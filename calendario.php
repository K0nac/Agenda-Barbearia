...
function MostreCalendario( $mes  )
{
	...
	echo "<table class='bg-white' border = 0 cellspacing = '0' align = 'center'>";
	 echo "<tr>";
	   ...
	   for( $coluna = 0; $coluna < 7; $coluna++ )
	   {
		...
		echo " align = 'center' valign = 'center'>";
		   ...
		   /* TRECHO IMPORTANTE: A PARTIR DESTE TRECHO É MOSTRADO UM DIA DO CALENDÁRIO (MUITA ATENÇÃO NA HORA DA MANUTENÇÃO) */
			 ...
			 {
				echo "<input type = 'button' id = 'dia_comum' name = 'dia".($diacorrente+1)."'  value = '".++$diacorrente."' onclick = 'null'>";
...
/* Pegar o mes atual, retorna um inteiro */
	$data = getdate();
?>

<div class='container bg-warning'>
    <?php MostreCalendario($data['mon'])?>
</div>
